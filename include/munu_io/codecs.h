#ifndef _DEF_MUNU_IO_CODECS_H_
#define _DEF_MUNU_IO_CODECS_H_

#include <string>

// base64 implementation taken from : https://stackoverflow.com/questions/180947/base64-decode-snippet-in-c
...
#endif //_DEF_MUNU_IO_CODECS_H_:set 
